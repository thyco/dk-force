...
-- reminders read; this file owns only the display.  Unlike Festering, which
-- picks either action bars or the Cooldown Manager, this decorates every icon it
-- finds in both places: the point is that the button you are looking at, in
-- whichever display you use, reads as "not this one".
